  ...
  */
  ...
  <View style={styles.container}>
    <View style={styles.searchView}>
      ...
      <Button title="Search" onPress={this.searchBooks} color='#254f23' style={styles.searchBtn} />
    </View>
    <View>
    <Text style={styles.splashScreen} >Let's Get Reading!</Text>
    </View>
